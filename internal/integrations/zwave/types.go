...
type ZWaveNode struct {
	...
	// Direct manufacturer info (sometimes deviceConfig is empty during interview)
...
const (
	...
	EventNodeReady        = "ready"                     // Fixed: Z-Wave JS sends "ready", not "node ready"
	EventNodeInterview    = "interview stage completed" // Fixed: Z-Wave JS sends "interview stage completed", not "node interview stage complete"
	...
	EventNodeWakeUp       = "wake up" // Fixed: Z-Wave JS sends "wake up", not "node wake up"
	EventNodeSleep        = "sleep"   // Fixed: Z-Wave JS sends "sleep", not "node sleep"
